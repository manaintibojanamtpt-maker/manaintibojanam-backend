      ...
      {isOpen && (
        <>
          ...
          <m.div
            ...
            className={`fixed bottom-0 left-0 right-0 z-[101] bg-white dark:bg-gray-900 rounded-t-[32px] shadow-2xl flex flex-col will-change-transform pb-safe ${panelClassName}`.trim()}
            style={{
