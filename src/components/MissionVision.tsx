...
export const MissionVision: React.FC = () => {
  return (
    <Section background="dark" className="text-white relative overflow-hidden">
      ...
      <SectionHeader 
        label="Why We Exist"
        title="Built for the Future of Food"
        description={missionData.mission}
      />
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 relative z-10">
        <GlassCard className="bg-white/5 dark:bg-white/5 border-white/10 dark:border-white/10">
          <IconContainer className="mb-6 bg-white/10 border-white/20 text-white"><Target /></IconContainer>
          <h3 className="text-2xl font-bold mb-4 text-white">Our Vision</h3>
          <p className="text-gray-300 leading-relaxed text-lg">{missionData.vision}</p>
        </GlassCard>
