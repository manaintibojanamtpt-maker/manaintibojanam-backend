...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@bhojan/location-v2': path.resolve(__dirname, '../src/features/location-v2'),
  ...
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ['favicon.svg', 'icons/icon-192.png', 'icons/icon-512.png', 'icons/apple-touch-icon-180x180.png'],
      manifest: {
        name: 'OrderBhojan',
