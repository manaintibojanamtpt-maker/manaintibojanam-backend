...
if (!String(pkg.version).includes('m15') && !String(pkg.version).includes('m16') && !String(pkg.version).includes('m2') && !String(pkg.version).includes('m3') && !String(pkg.version).includes('m4')) {
